      ...
      <div className="flex flex-col items-center gap-3 md:flex-row md:justify-between">
        <div>
          <div className="bg-gradient-to-r from-[#00f0ff] via-[#ff43f8] to-[#ffe600] bg-clip-text text-[11px] font-black uppercase tracking-[0.15em] text-transparent">
            {hasReachedUnlockThreshold ? "¡Perfil Sonoro listo!" : "Guarda tu progreso"}
          </div>
          <p className="text-sm text-[#d8ebff]">
            {copyVariant === "unlock_dna"
              ? "Inicia sesión para desbloquear tu Perfil Sonoro y obtener recomendaciones personalizadas basadas en tus votos."
              : "Sigue jugando como invitado y, a continuación, inicia sesión para guardar tu progreso en todos tus dispositivos"}
          </p>
        </div>
