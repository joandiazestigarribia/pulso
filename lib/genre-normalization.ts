...
type MacroGenreKey = keyof typeof MACRO_GENRE_LABELS
...
function fallbackMacroGenre(signal: string): MacroGenreKey {
...
export function normalizeTrackGenre(rawGenre: string): NormalizedGenre {
